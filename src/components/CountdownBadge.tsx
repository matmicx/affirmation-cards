...
const BASE_PERIMETER = Math.PI * INNER_HEIGHT;
...
export function CountdownBadge({
  ...
  const gradientStart = useMemo(() => lightenHex(strokeColor, 0.45), [strokeColor]);
  ...
  const chipScale = modeAnim.interpolate({
    inputRange: [0, 1],
    outputRange: [1, 1],
  });
...
useEffect(() => {
...
}, [expanded, targetWidth, modeAnim, updateRenderWidth]);
  ...
  }, [expanded, animateTo, contentOpacity]);
  ...
  return (
    <>
      ...
      >
        ...
        <Animated.View style={[styles.strokeWrapper, { width: renderWidth }]}>
        <Svg
          width={renderWidth}
          height={BADGE_SIZE}
